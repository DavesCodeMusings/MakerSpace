...
## Installing git from the terminal
While you still have the terminal session open from installing _gnome-system-tools_, run the following command to install _git_.
